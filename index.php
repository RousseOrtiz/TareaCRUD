...
<div class="container mt-5">
    <div class="row justify-content-center">
        ...
        <div class="col-md-7">
            ...
            <strong>Registrado!</strong> Se ha agregado un nuevo producto!
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
            <?php 
                }
                    ...
                    <table class="table align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a onclick="return confirm('Desea eliminar producto?');" class="text-danger" href="eliminar.php?id=<?php echo $dato->id; ?>"><i class="bi bi-trash"></i></a></td>
                            </tr>
